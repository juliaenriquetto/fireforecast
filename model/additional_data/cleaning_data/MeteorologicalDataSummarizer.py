...
input_file = 'INMET_SE_SP_BAURU_2019_original.csv'  # Substitua pelo caminho do arquivo CSV original
output_file = 'INMET_SE_SP_BAURU_2019.csv'  # Nome do novo arquivo CSV
