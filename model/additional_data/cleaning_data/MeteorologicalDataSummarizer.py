...
input_file = 'INMET_N_RR_BOA VISTA_2023_original.csv'  # Substitua pelo caminho do arquivo CSV original
output_file = 'INMET_N_RR_BOA VISTA_2023.csv'  # Nome do novo arquivo CSV
