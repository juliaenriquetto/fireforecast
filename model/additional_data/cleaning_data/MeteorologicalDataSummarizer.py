...
input_file = 'INMET_NE_SE_ARACAJU_2021_original.csv'  # Substitua pelo caminho do arquivo CSV original
output_file = 'INMET_NE_SE_ARACAJU_2021.csv'  # Nome do novo arquivo CSV
